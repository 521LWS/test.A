...
# 5. 计算模块特征向量与临床特征的相关系数矩阵（需更改临床数据名称）
...
red_alpha <- rgb(1, 0, 0, alpha = 0.5, maxColorValue = 1)
blue_alpha <- rgb(0, 0, 1, alpha = 0.5, maxColorValue = 1)
white <- "white"
